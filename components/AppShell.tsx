...
export function AppShell() {
  ...
  const { isDark, toggleTheme, themeMode, schedule, coords, sunTimes, setThemeMode, setSchedule, setCoords } = useTheme();
          ...
          <div ref={localeMenuRef} style={{ position: "relative", display: "flex" }}>
            <button
              ...
              style={{
                ...
                fontSize: 13, fontWeight: 600, transition: "color 0.12s, background 0.12s",
              }}
                ...
                {(["zh-CN", "en"] as const).map((l) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      color: l === locale ? "var(--text)" : "var(--text-muted)",
